...
#define BOOST_TEST_MODULE KeyboardWarriorCoin Test Suite
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_keyboardwarriorcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
