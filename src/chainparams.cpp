...
// Copyright (c) 2021 KeyboardWarriorCoin Core developers
...
{
    const char* pszTimestamp = "NY Times 21/Nov/2021 Is the future too dark to have children?";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b63057fb6798bc4a8e4d3eb4b10f4d4604fa08dce601aaf0ad20216fe1abc850b4acf21b177825070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
		...
		*/
        ...
        consensus.nPowTargetSpacing = 1 * 18;
	...
	*/
		...
		assert(genesis.hashMerkleRoot == uint256S("0x208d860220cc3eca1258931bc8eb0b8fbc7b3bef4f97250c781fb6da003536cf"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x4f986801e82571f027d8ec032e40b449c6698a71e1d089b2d285ef03c8862d10"))
            (  1, uint256S("0xc74f3992b09c1a2fa8b14f4822dfc421b7d88436d6fccb63fdb8969bc8f2b611"))
...
public:
    CTestNetParams() {
		...
		*/
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
		assert(genesis.hashMerkleRoot == uint256S("0x208d860220cc3eca1258931bc8eb0b8fbc7b3bef4f97250c781fb6da003536cf"));
        assert(consensus.hashGenesisBlock == uint256S("0x925ac6a8098c8815944cd55b0b7658553d10829b0b00c544899c19e850cb7609"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x925ac6a8098c8815944cd55b0b7658553d10829b0b00c544899c19e850cb7609")),
        };
...
public:
    CRegTestParams() {
		...
		*/
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
		assert(genesis.hashMerkleRoot == uint256S("0x208d860220cc3eca1258931bc8eb0b8fbc7b3bef4f97250c781fb6da003536cf"));
        assert(consensus.hashGenesisBlock == uint256S("0xc0b89c0b3c8341f9bba09e28293c5d1b71b819185f6d5b008b3be3222c65b460"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xc0b89c0b3c8341f9bba09e28293c5d1b71b819185f6d5b008b3be3222c65b460"))
        };
