...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s keyboardwarriorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  keyboardwarriorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded keyboardwarriorcoin transaction") + "\n" +
              "  keyboardwarriorcoin-tx [options] -create [commands]   " + _("Create hex-encoded keyboardwarriorcoin transaction") + "\n" +
              "\n";
