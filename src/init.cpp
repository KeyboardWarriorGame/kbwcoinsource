...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/keyboardwarriorcoin-project/keyboardwarriorcoin>";
    const std::string URL_WEBSITE = "<https://keyboardwarriorcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("KeyboardWarriorCoin version %s\n", FormatFullVersion());
}
